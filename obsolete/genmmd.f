C--- SPARSPAK-A (ANSI FORTRAN) RELEASE III --- NAME = SLGENMMD
C  (C)  UNIVERSITY OF WATERLOO   JANUARY 1984
C***************************************************************
C***************************************************************
C****     SLGENMMD ..... MULTIPLE MINIMUM EXTERNAL DEGREE     ****
C***************************************************************
C***************************************************************
C
...
C        SLMMDELM, SLMMDINT, SLMMDNUM, SLMMDUPD.
C
C***************************************************************
C
      SUBROUTINE  SLGENMMD ( NEQNS, XADJ, ADJNCY, INVP, PERM,
...
C        ------------------------------------------------
         NOFSUB = 0
         CALL  SLMMDINT ( NEQNS, XADJ, ADJNCY, DHEAD, INVP, PERM,
...
C                ----------------------------------------------
  ...
  700                CONTINUE
  800            CONTINUE
                 CALL  SLMMDELM ( MDNODE, XADJ, ADJNCY, DHEAD, INVP,
...
C            -------------------------------------------
             IF  ( NUM .GT. NEQNS )  GO TO 1000
             CALL  SLMMDUPD ( EHEAD, NEQNS, XADJ, ADJNCY, DELTA, MDEG,
     1                      DHEAD, INVP, PERM, QSIZE, LLIST, MARKER,
     1                      MAXINT, TAG )
             GO TO 300
C
 1000    CONTINUE
         CALL  SLMMDNUM ( NEQNS, PERM, INVP, QSIZE )
         RETURN
C
      END SUBROUTINE
C--- SPARSPAK-A (ANSI FORTRAN) RELEASE III --- NAME = SLMMDINT
C  (C)  UNIVERSITY OF WATERLOO   JANUARY 1984
C***************************************************************
C***************************************************************
C***     SLMMDINT ..... MULT MINIMUM DEGREE INITIALIZATION     ***
C***************************************************************
C***************************************************************
C
...
C***************************************************************
C
      SUBROUTINE  SLMMDINT ( NEQNS, XADJ, ADJNCY, DHEAD, DFORW,
...
C
      END SUBROUTINE
C--- SPARSPAK-A (ANSI FORTRAN) RELEASE III --- NAME = SLMMDNUM
C  (C)  UNIVERSITY OF WATERLOO   JANUARY 1984
C***************************************************************
C***************************************************************
C*****     SLMMDNUM ..... MULTI MINIMUM DEGREE NUMBERING     *****
C***************************************************************
C***************************************************************
C
...
C***************************************************************
C
      SUBROUTINE  SLMMDNUM ( NEQNS, PERM, INVP, QSIZE )
C
C***************************************************************
C
...
C
      END SUBROUTINE
C--- SPARSPAK-A (ANSI FORTRAN) RELEASE III --- NAME = SLMMDUPD
C  (C)  UNIVERSITY OF WATERLOO   JANUARY 1984
C***************************************************************
C***************************************************************
C*****     SLMMDUPD ..... MULTIPLE MINIMUM DEGREE UPDATE     *****
C***************************************************************
C***************************************************************
C
...
C***************************************************************
C
      SUBROUTINE  SLMMDUPD ( EHEAD, NEQNS, XADJ, ADJNCY, DELTA,
...
C
      END SUBROUTINE
C--- SPARSPAK-A (ANSI FORTRAN) RELEASE III --- NAME = SLMMDELM
C  (C)  UNIVERSITY OF WATERLOO   JANUARY 1984
C***************************************************************
C***************************************************************
C**     SLMMDELM ..... MULTIPLE MINIMUM DEGREE ELIMINATION     ***
C***************************************************************
C***************************************************************
C
...
C***************************************************************
C
      SUBROUTINE  SLMMDELM ( MDNODE, XADJ, ADJNCY, DHEAD, DFORW,
